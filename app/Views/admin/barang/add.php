            ...
            <div class="card-body">
                <form action="<?= base_url('item/save') ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('display_name')) ? 'is-invalid' : ''; ?>" id="display_name" name="display_name" value="<?= old('display_name'); ?>">
                            <div class="invalid-feedback">Display Nama</div>
                        </div>
                    </div>
